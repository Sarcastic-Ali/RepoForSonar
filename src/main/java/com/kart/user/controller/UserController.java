...
public class UserController {
	...
	//partially working, stocks in productdb is not getting updated and its overriding data in cart, not adding it	
	...
	//working
	@PutMapping(value = "/api/buyer/updateRewardPoints/{buyerId}/{rewPoints}")
